		...
		<div class="container">
			<div class="agileinfo_single">
				...
				<div class="col-md-4 agileinfo_single_left">
					<img id="example" src="images/bv2.png" alt=" " class="img-responsive">
				</div>
				<div class="col-md-8 agileinfo_single_right">
				<h2> Frooti Orange-juice</h2>
					<div class="rating1">
					...
					<div class="w3agile_description">
						<h4>Description :</h4>
						<p>There are four categories of packaged orange drinks available in the whole world market today. 
						Mind it, we say 'drinks' and not juices; not all orange drinks can reach the exalted status of juices, 
						they need to meet some parameters to be called so, starting with the composition..</p>
					</div>
