...
<html>
<head>
<title>Super Market an Ecommerce Online Shopping Category Flat Bootstrap Responsive Website Template | Single Page </title>
<!-- for-mobile-apps -->
		...
		<div class="container">
			<div class="agileinfo_single">
				...
				<div class="col-md-4 agileinfo_single_left">
					<img id="example" src="images/bv3.png" alt=" " class="img-responsive">
				</div>
				...
				<h2> Tropicana</h2>
					<div class="rating1">
						<span class="starRating">
							...
							<input id="rating2" type="radio" name="rating" value="1">
					...
					<div class="w3agile_description">
						<h4>Description :</h4>
						<p>And the fourth is the sugar-free category like Tropicana 100% which has no added sugar but real pulp, concentrate and water.
						While the fruit used in the pulpy juices is very much real, it's not necessary that it will be mango. 
						For instance, apples are often mixed with really saccharine fruit like grapes to lend an intensely sweet taste to the juice.
						There might be very little mango, with huge quantities of cheaper fruits like beetroot being added..</p>
					</div>
