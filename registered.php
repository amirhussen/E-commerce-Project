	...
	$db=mysqli_connect("localhost","root","","alhaj");
		...
		if(isset($_POST['register_btn'])){
			...
			if($Password==$Password){
				...
				$sql="INSERT INTO register(Frist_Name,Last_Name,Email,Password,User_Type,Phone,City,Address,Postal_Code) VALUES('$Frist_Name','$Last_Name','$Email','$Password','$User_Type','$Phone','$City','$Address','$Postal_Code')";
				mysqli_query($db,$sql);
	...
	<div class="navigation-agileits">
		<div class="container">
			<nav class="navbar navbar-default">
				<marquee><br><p>Please Registration Here</p><br></marquee>		
			</nav>
			</div>
		</div>
		...
		<div class="container">
			...
			<div class="login-form-grids">
				...
				<form action="registered.php" method="post">
					...
					<input type="text" placeholder="User Type" name="User_Type" required=" " ><br>
