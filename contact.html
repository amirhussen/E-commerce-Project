...
<html>
<head>
<title>Super Market an Ecommerce Online Shopping Category Flat Bootstrap Responsive Website Template | Contact </title>
<!-- for-mobile-apps -->
			...
			<div class="col-md-6 w3_agileits_contact_grid_left">
				...
				<div class="agileits_w3layouts_map_pos">
					<div class="agileits_w3layouts_map_pos1">
						<h3>Contact Info</h3>
						<p>Blue water, 4th block, Sylhet City.</p>
						<ul class="wthree_contact_info_address">
							<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="supermarket@gma.comil">Super market</a></li>
							<li><i class="fa fa-phone" aria-hidden="true"></i>01774695315</li>
						</ul>
